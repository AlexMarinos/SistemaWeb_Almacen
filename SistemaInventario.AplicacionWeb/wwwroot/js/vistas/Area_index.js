...
$("#btnGuardar").click(function () {
    ...
    modelo["idArea"] = parseInt($("#txtId").val())
        ...
        fetch("/Area/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El área fue creada", "success");
                } else {
        ...
        fetch("/Area/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide");
                    swal("Listo!", "El área fue modificada", "success");
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error");
                }
            })
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Está seguro?",
        text: `Eliminar al área ${data.descripcion}`,
        type: "warning",
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Area/Eliminar?idArea=${data.idArea}`, {
                    method: "DELETE"
                })
                    .then(response => {
